...
// UnmarshalJSON decodes a CodeBuddy credential exactly as the host hands it back.
//
...
func (c *Credential) UnmarshalJSON(data []byte) error {
	coerced, errCoerce := credjson.CoerceToStrings(data, "expires_at", "refresh_expires_at")
	if errCoerce != nil {
		return errCoerce
	}
