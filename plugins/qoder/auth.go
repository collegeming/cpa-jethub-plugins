...
// carries neither a nickname nor a uid, and that token rotates on every refresh
// — a refresh that derived a name would leave the file the host asked us to
// renew behind and write a second one.
